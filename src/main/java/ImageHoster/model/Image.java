...
public class Image {
	...
	// The table (primary key) is referenced by the 'comments' field in the 'images'
	// table
	// record in 'comments' table will be deleted first and then the record in the
	// 'images' table will be deleted
	// FetchType is EAGER
